...
enum class Tile1 private constructor(//中

    val code: Int, val type: TileType, val number: Int
) {
    ...
    val isYaochu: Boolean
        get() = number == 0 || number == 1 || number == 9

    companion object {

        fun valueOf(c: Int): Tile1 {
            return Tile1.values()[c]
        }
    }
}